function fetchUpdatePriceNQtyFGX() {
  ...
  submitPriceAndInventoryFeedForFGX();
}
...
function submitPriceAndInventoryFeedForFGX() {
  var feedContent = constructFeedContentForFGX();
  ...
  logSheet.getRange('A' + lastRow).setValue("FGX");
}

function confirmAndDownloadProcessingForFGX() {
  var lastRow = logSheet.getLastRow();
...
function constructFeedContentForFGX() {
  var sheet = spreadsheet.getSheetByName('FGX');

function fetchUpdatePriceNQtyAFJCA() {
  ...
  submitPriceAndInventoryFeedForAFJCA();
}
...
function submitPriceAndInventoryFeedForAFJCA() {
  var feedContent = constructFeedContentForAFJCA();
  ...
  logSheet.getRange('A' + lastRow).setValue("AFJ_CA");
}

function confirmAndDownloadProcessingForAFJCA() {
  var lastRow = logSheet.getLastRow();
...
function constructFeedContentForAFJCA() {
  var sheet = spreadsheet.getSheetByName('AFJ_CA');
